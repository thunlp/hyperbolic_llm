...
BERT_CONFIG=$BERT_PREP_WORKING_DIR/bert_base.json
...
RESULTS_DIR=$CODEDIR/results/base_dp=0.1_attdp=0.1_lr=2e-3_dg=1
...
cp $CODEDIR/bert_base.json $RESULTS_DIR
...
CMD+=" --poly_degree $poly_degree_phase1"
