...
init_checkpoint=${1:-"/apdcephfs/share_47076/weizechen/hilbert/residual-timecorrect/results/large_dp=0.1_attdp=0.1_lr=6e-4_step=30000/checkpoints/ckpt_33000.pt"}
data_dir=${2:-"/apdcephfs/share_47076/weizechen/hilbert/data/download/re_dataset/datasets/tacrev/marker"}
...
out_dir=${5:-"/apdcephfs/share_47076/weizechen/hilbert/residual-timecorrect/results/large/tacrev"}
num_gpu=${7:-"2"}
batch_size=${8:-"32"}
...
out_dir=${5:-"/apdcephfs/share_47076/weizechen/hilbert/residual-timecorrect/results/large/tacrev/lr=${lr}_gn=${gn}_wd=${wd}"}
...
#   unset CUDA_VISIBLE_DEVICES
  mpi_command=" -m torch.distributed.launch --nproc_per_node=$num_gpu --master_port 12345"
fi
