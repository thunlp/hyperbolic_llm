...
for learning_rate in 5e-5 3e-5 1e-5 5e-6 3e-6; do
  for alpha in 5 10 20; do
      for beta in 0.1 0.2 0.4; do
        for weight_decay in 0; do
          for max_grad_norm in 0 1; do
...
#   unset CUDA_VISIBLE_DEVICES
  mpi_command=" -m torch.distributed.launch --nproc_per_node=$num_gpu --master_port 12349"
# fi
