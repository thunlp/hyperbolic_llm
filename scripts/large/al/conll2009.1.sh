...
--train_path /apdcephfs/share_47076/weizechen/hilbert/residual-timecorrect/../data/download/srl/conll2009/large/arg_labeling/1_query_type2.1/train \
--dev_path /apdcephfs/share_47076/weizechen/hilbert/residual-timecorrect/../data/download/srl/conll2009/large/arg_labeling/1_query_type2.1/dev \
--max_tokens 1024 \
--max_epochs 20 \
--lr 5e-6 \
--max_grad_norm 1 \
...
--save_path /apdcephfs/share_47076/weizechen/hilbert/residual-timecorrect/results/large/al/conll09/5e-6 \
--train \
--eval \
--save \
--test \
