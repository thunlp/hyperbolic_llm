...
data_dir=${2:-"/apdcephfs/share_47076/weizechen/hilbert/data/download/re_dataset/datasets/tacred"}
...
out_dir=${5:-"/apdcephfs/share_47076/weizechen/hilbert/residual-timecorrect/results/large/tacred"}
num_gpu=${7:-"2"}
batch_size=${8:-"32"}
...
out_dir=${5:-"/apdcephfs/share_47076/weizechen/hilbert/residual-timecorrect/results/large/tacred/lr=${lr}_gn=${gn}_wd=${wd}"}
