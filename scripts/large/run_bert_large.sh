...
export BERT_PREP_WORKING_DIR="/home/hx/chenweize/DeepLearningExamples/PyTorch/LanguageModeling/BERT/data/"
...
RESULTS_DIR=$CODEDIR/results/new_base_dp=0.1_attdp=0.1_lr=2e-3_step=20000
...
CMD="python3 -m torch.distributed.launch --nproc_per_node=$num_gpus --nnodes 1 --master_port 12956 --master_addr 103.242.175.228 --node_rank 0 $CMD"
# CMD="python3 $CMD"
