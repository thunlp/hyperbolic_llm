...
export BERT_PREP_WORKING_DIR="/home/zhangzhengyan/DeepLearningExamples-master/PyTorch/LanguageModeling/BERT/data/"
...
learning_rate_phase2=${17:-"3e-3"}
warmup_proportion_phase2=${18:-"0.1"}
train_steps_phase2=${19:-1500}
...
log_freq=${26:-10}
max_grad_norm=${27:-0.5}
beta1_adam_phase1=${28:-0.9}
beta2_adam_phase1=${29:-0.999}
beta1_adam_phase2=${30:-0.9}
beta2_adam_phase2=${31:-0.999}
RESULTS_DIR=$CODEDIR/results/dp_0.1_attdp_0/
CHECKPOINTS_DIR=$RESULTS_DIR/checkpoints

mkdir -p $CHECKPOINTS_DIR
CURR_DIR="$( cd "$( dirname "${BASH_SOURCE[0]}" )" &> /dev/null && pwd )"
cp $CURR_DIR/${0##*/} $RESULTS_DIR
cp modeling.py $RESULTS_DIR
cp scripts/run_bert.sh $RESULTS_DIR
cp run_pretraining.py $RESULTS_DIR
cp bert_large.json $RESULTS_DIR
...
CMD+=" --adam_beta1=$beta1_adam_phase1"
CMD+=" --adam_beta2=$beta2_adam_phase1"
...
CMD+=" --log_freq=$log_freq"
CMD+=" --max_grad_norm=$max_grad_norm"
CMD+=" --adam_beta1=$beta1_adam_phase2"
CMD+=" --adam_beta2=$beta2_adam_phase2"
