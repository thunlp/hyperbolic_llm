...
--save_path /apdcephfs/share_47076/weizechen/hilbert/residual-timecorrect/results/srl/conll05/5e-6 \
--predict \
--save \
...
--output_path /apdcephfs/share_47076/weizechen/hilbert/residual-timecorrect/../data/download/srl/conll2005/${task}.english.psense.conll05.json \
--checkpoint_path /apdcephfs/share_47076/weizechen/hilbert/residual-timecorrect/results/srl/conll05/5e-6 \
--tqdm_mininterval 1
done
