...
def main():
    ...
    if args.do_train:
        ...
        num_train_optimization_steps = int(math.ceil(
    ...
    if args.do_train:
        ...
        model.train()
        gradClipper = GradientClipper(max_grad_norm=args.max_grad_norm)
        final_loss = None
    ...
    if args.do_predict and (args.local_rank == -1 or is_main_process()):
        ...
        eval_dataloader = DataLoader(eval_data, sampler=eval_sampler, batch_size=args.predict_batch_size, num_workers=4, pin_memory=True)
